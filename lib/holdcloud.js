 ...
 * @return  {array}         列表
 */
HoldCloud.prototype.listStatelessService = async function (projectId) {
 ...
 * @return  {integer}         服务id
 */
HoldCloud.prototype.createStatelesscontainerApps = async function (projectId, options) {
 ...
 * @return  {Object}           {}
 */
HoldCloud.prototype.createStatelessService = async function (appId, options) {
  return await this.requestWithToken({
    method: 'POST',
 ...
 * @return  {[Object]}       [{}]
 */
HoldCloud.prototype.destroyStatelessService = async function (appId) {
  return await this.requestWithToken({
    method: 'DELETE',
 ...
 * @param  {integer} appId  [app 编号]
 */
HoldCloud.prototype.restartStatelessService = async function (appId) {
  return await this.requestWithToken({
    method: 'POST',
